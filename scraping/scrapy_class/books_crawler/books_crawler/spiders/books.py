...
class BooksSpider(Spider):
    ...
    def parse_book(self, response):
        ...
        # look at what changed and stayed the same
...
#
#     #allowed_domains
#     rules = (Rule(LinkExtractor(deny_domains=('google.com')), callback='parse_page', follow=True),)  # we dont need slef because its in the sasame layer. Parse is reserved for default spider
#
#     def parse(self, response):
